...
function matricesIguales(arreglo01, arreglo02) {
    var tamaño = arreglo1[0].length;
    var tamaño1 = arreglo1[1].length;
    var tamaño2 = arreglo2[0].length;
    var tamaño3 = arreglo2[1].length;
    var tamaño4 = arreglo1.length;
    var tamaño5 = arreglo2.length;
